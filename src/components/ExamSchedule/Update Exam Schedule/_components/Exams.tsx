...
const Exams = ({ control, singleExamSchedule }: ExamsInfoProps) => {
    ...
    useEffect(() => {
        if (fields.length === 0) {
            replace(singleExamSchedule?.data?.exams || [{ courseName: "", courseCode: "", maxMark: "", startTime: "", endTime: "" }]);
        }
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 w-full">
                                ...
                                <div>
                                    ...
                                    <Controller
                                        ...
                                        control={control}
                                        defaultValue={singleExamSchedule?.data?.exams?.[index]?.courseName || ""}
                                ...
                                <div>
                                    ...
                                    <Controller
                                        ...
                                        control={control}
                                        defaultValue={singleExamSchedule?.data?.exams?.[index]?.courseCode || ""}
                                ...
                                <Controller
                                    ...
                                    control={control}
                                    defaultValue={singleExamSchedule?.data?.exams?.[index]?.startTime || ""}
                                ...
                                <Controller
                                    ...
                                    control={control}
                                    defaultValue={singleExamSchedule?.data?.exams?.[index]?.endTime || ""}
